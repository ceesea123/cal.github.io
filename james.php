...
color : red ; font-family :'Times New Roman'"> Enter First Number </td >
<td colspan="1">
<input name ="fvalue"
type ="text" style ="color : red "/></td>
<tr>
...
style ="color : wheat;background-color : rosybrown" />
<input name="reset" type="submit" value="Reset" src="" clas="reset_button" style ="color : wheat;background-color : rosybrown" 
onlick="reset();" />
</td>
